...
public:
    ...
    // if they are the same, leave at the set values, and throw Error("Load and unload cargo destinations are the
    // same!") if both destinations are now set, start the cargo cycle
